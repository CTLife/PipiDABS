...
myMainFunction_1_g  <- function(  myobj_temp2,   path_temp2,  qvalue_temp2, differenceOfMethylation_temp2, mergeDistance_temp2,  binSize_temp2,    stepSize_temp2,   binBases_temp2, dataFrame_temp2, numCores_temp2  ) {                                                   
  ...
  tryCatch(
    myTempFunction101(),
    error = function(err){"Tiles_00011kkkkkkkkkkkkkkkkkkkk1333"}
  )
  ...
  tryCatch(
    myTempFunction101(),
    error = function(err){"myMainFunction_1_g_11133355555"}
  )
  ...
  tryCatch(
    myTempFunction102(),
    error = function(err){"myMainFunction_1_g_111222333"}
  )
