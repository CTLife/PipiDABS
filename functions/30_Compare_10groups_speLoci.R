...
myCompare_10groups_speLoci_g <- function(methylBase_temp_1,  myPath_temp_1,  qvalue_temp_1,  differenceOfMethylation_temp_1,  mergeDistance_temp1,  minBases_temp_1,  numCores_temp_1 ) {                                             
...
if( (! is.null(Label_one_1_g)) && (! is.null(Label_two_2_g))   ) {
  dataFrame_temp2_A <- data.frame(
      ...
      mytreatment = c(Treatment_one_1_g,  rep(99, length(Treatment_two_2_g)),  rep(99, length(Treatment_three_3_g)),  rep(99, length(Treatment_four_4_g)),  rep(99, length(Treatment_five_5_g)),  rep(99, length(Treatment_six_6_g)),   rep(99, length(Treatment_seven_7_g)),   rep(99, length(Treatment_eight_8_g)),    rep(99, length(Treatment_nine_9_g)),   rep(99, length(Treatment_ten_10_g))  ),                            
     ...
     myMainFunction_speRegions_All_g(myobj_temp3 = methylBase_temp_1,     
                       path_temp3  = paste(myPath_temp_1, "/0_AllSamples",   sep="")  ,   
                       ...
                       binBases_temp3=minBases_temp_1, dataFrame_temp3=dataFrame_temp2_A, numCores_temp3=numCores_temp_1 
                      ) 
}
