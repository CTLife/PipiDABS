...
myCorCov_matrix_1 <- function(matrix_temp10, path_temp10, my_col1 ) {
  ...
  MyHeatmaps_1_f(matrix2=covariance_spearman_scaled,  path2=path_temp10_sub2,   fileName2="3_covariance_pearson_scaled.corrplot.pdf",          height2=30,   width2=30, is.corr2=TRUE,  my_col2=my_col1(10) )                             
  MyHeatmaps_2_f(matrix2=covariance_spearman_scaled,  path2=path_temp10_sub2,   fileName2="4_covariance_pearson_scaled.heatmap.pdf",           height2=30,   width2=30 )  
  MyHeatmaps_3_f(matrix2=covariance_spearman_scaled,  path2=path_temp10_sub2,   fileName2="5_covariance_pearson_scaled.ComplexHeatmap.pdf",    height2=30,   width2=30 )  
  ...
  MyHeatmaps_1_f(matrix2=Correlation_pearson_scaled,  path2=path_temp10_sub3,   fileName2="3_covariance_pearson_scaled.corrplot.pdf",          height2=30,   width2=30, is.corr2=TRUE,  my_col2=my_col1(10) )                             
  MyHeatmaps_2_f(matrix2=Correlation_pearson_scaled,  path2=path_temp10_sub3,   fileName2="4_covariance_pearson_scaled.heatmap.pdf",           height2=30,   width2=30 )  
  MyHeatmaps_3_f(matrix2=Correlation_pearson_scaled,  path2=path_temp10_sub3,   fileName2="5_covariance_pearson_scaled.ComplexHeatmap.pdf",    height2=30,   width2=30 )  
  

  Correlation_pearson_rcorr <- rcorr(  as.matrix(matrix_temp10),  type="pearson"  )
  ...
  MyHeatmaps_1_f(matrix2=Correlation_pearson_rcorr$r,  path2=path_temp10_sub3,   fileName2="13_covariance_pearson_scaled.corrplot.pdf",          height2=30,   width2=30, is.corr2=TRUE,  my_col2=my_col1(10) )                             
  MyHeatmaps_2_f(matrix2=Correlation_pearson_rcorr$r,  path2=path_temp10_sub3,   fileName2="14_covariance_pearson_scaled.heatmap.pdf",           height2=30,   width2=30 )  
  MyHeatmaps_3_f(matrix2=Correlation_pearson_rcorr$r,  path2=path_temp10_sub3,   fileName2="15_covariance_pearson_scaled.ComplexHeatmap.pdf",    height2=30,   width2=30 )  
  ...
  MyHeatmaps_1_f(matrix2=Correlation_spearman_scaled,  path2=path_temp10_sub4,   fileName2="3_covariance_pearson_scaled.corrplot.pdf",          height2=30,   width2=30, is.corr2=TRUE,  my_col2=my_col1(10) )                             
  MyHeatmaps_2_f(matrix2=Correlation_spearman_scaled,  path2=path_temp10_sub4,   fileName2="4_covariance_pearson_scaled.heatmap.pdf",           height2=30,   width2=30 )  
  MyHeatmaps_3_f(matrix2=Correlation_spearman_scaled,  path2=path_temp10_sub4,   fileName2="5_covariance_pearson_scaled.ComplexHeatmap.pdf",    height2=30,   width2=30 )  
  

  Correlation_spearman_rcorr <- rcorr(  as.matrix(matrix_temp10),  type="spearman"  )
  ...
  write.table(x=Correlation_spearman_rcorr_format, file = paste(path_temp10_sub4, "12_Correlation_spearman_rcorr_format.txt", sep="/"), 
              append = FALSE,  quote = FALSE, sep = "\t",  eol = "\n",  na = "NA",  dec = ".",   row.names = FALSE,  col.names = TRUE )
  MyHeatmaps_1_f(matrix2=Correlation_spearman_rcorr$r,  path2=path_temp10_sub4,   fileName2="13_covariance_pearson_scaled.corrplot.pdf",          height2=30,   width2=30, is.corr2=TRUE,  my_col2=my_col1(10) )                             
  MyHeatmaps_2_f(matrix2=Correlation_spearman_rcorr$r,  path2=path_temp10_sub4,   fileName2="14_covariance_pearson_scaled.heatmap.pdf",           height2=30,   width2=30 )  
  MyHeatmaps_3_f(matrix2=Correlation_spearman_rcorr$r,  path2=path_temp10_sub4,   fileName2="15_covariance_pearson_scaled.ComplexHeatmap.pdf",    height2=30,   width2=30 )  
