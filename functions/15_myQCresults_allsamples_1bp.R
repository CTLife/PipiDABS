...
myQCresults_allsamples_1bp <- function(methylBase_temp1, path_temp1) {
  ...
  tryCatch(
    myTempFunction(),
    error = function(err){"mySelectDiffMe_999999999999955555"}
  ) 
  ...
  tryCatch(
    myTempFunction101(),
    error = function(err){"myQCresults_allsamples_1bp_000111333"}
  )
  ...
  tryCatch(
    myTempFunction102(),
    error = function(err){"myQCresults_allsamples_1bp_111222333"}
  )
