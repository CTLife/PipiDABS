...
### Author: Yong Peng
### Version 0.1.1, September 30th, 2018
...
parser_Local <- optparse::OptionParser(usage="usage: %prog [options]",
		...
		description="PipiDABS: A Comprehensive and User-Friendly Pipeline for Downstream DNA Methylation Analysis of High-throughput Bisulfite Sequencing Data. Version 0.1.1, September 30th, 2018.",                             
