...
forEachType_f <- function(path_temp, matrix_temp, dataFrame_temp) {
   ...
   sink( paste(path_temp_sub1, "dimensions_16stats.txt", sep="/") )
    ...
    write.table(quartile0_matrix2 , 
              file      = paste(path_temp_sub1,   "1A_quartile0_matrix.txt",  sep="/"), 
    ...
    MyBoxViolinPlot_1_f(vector2 = as.vector(quartile0_matrix2) ,   
                    ...
                    path2       = path_temp_sub1,   fileName2 = "1B_quartile0_matrix",  
    ...
    write.table( cbind(as.vector(quartile0_matrix2), rep(x= mytech2_level ,  each=nrow(matrix_temp)  ) ) , 
              file      = paste(path_temp_sub1,   "1C_quartile0_matrix.txt",  sep="/"), 
              append    = FALSE, quote = FALSE, sep = "\t", eol = "\n", na = "NA", dec = ".", 
              row.names = FALSE,  col.names = TRUE, qmethod = c("escape", "double"),  fileEncoding = "") 


    write.table(quartile25_matrix2 , 
              file = paste(path_temp_sub1,   "2A_quartile25_matrix.txt",  sep="/"), 
              append = FALSE, quote = FALSE, sep = "\t", eol = "\n", na = "NA", dec = ".", 
              row.names = FALSE,  col.names = TRUE, qmethod = c("escape", "double"),  fileEncoding = "")  
    MyBoxViolinPlot_1_f(vector2 = as.vector(quartile25_matrix2) ,   
                    sampleType2 = rep(x= mytech2_level ,  each=nrow(matrix_temp)  )   ,  
                    colours2    = MyTech_color_g(  mytech2_level  ),   
                    path2       = path_temp_sub1,   fileName2 = "2B_quartile25_matrix",  
                    title2="quartile25",  xLab2="Samples",  yLab2="quartile25 of methylation level (%)",    
                    height2=4,   width2= length(mytech2_level)/2+2,   Ymin2=0, Ymax2=100)
    write.table( cbind(as.vector(quartile25_matrix2), rep(x= mytech2_level ,  each=nrow(matrix_temp)  ) ) , 
              file = paste(path_temp_sub1,   "2C_quartile25_matrix.txt",  sep="/"), 
              append = FALSE, quote = FALSE, sep = "\t", eol = "\n", na = "NA", dec = ".", 
              row.names = FALSE,  col.names = TRUE, qmethod = c("escape", "double"),  fileEncoding = "") 
    ...
    write.table(quartile75_matrix2 , 
              file = paste(path_temp_sub1,   "4A_quartile75_matrix.txt",  sep="/"), 
              append = FALSE, quote = FALSE, sep = "\t", eol = "\n", na = "NA", dec = ".", 
              row.names = FALSE,  col.names = TRUE, qmethod = c("escape", "double"),  fileEncoding = "")  
    MyBoxViolinPlot_1_f(vector2 = as.vector(quartile75_matrix2) ,   
                    sampleType2 = rep(x= mytech2_level ,  each=nrow(matrix_temp)  )   ,  
                    colours2    = MyTech_color_g(  mytech2_level  ),   
                    path2       = path_temp_sub1,   fileName2 = "4B_quartile75_matrix",  
                    title2="quartile75",  xLab2="Samples",  yLab2="quartile75 of methylation level (%)",    
                    height2=4,   width2= length(mytech2_level)/2+2,   Ymin2=0, Ymax2=100)
    write.table( cbind(as.vector(quartile75_matrix2), rep(x= mytech2_level ,  each=nrow(matrix_temp)  ) ) , 
              file = paste(path_temp_sub1,   "4C_quartile75_matrix.txt",  sep="/"), 
              append = FALSE, quote = FALSE, sep = "\t", eol = "\n", na = "NA", dec = ".", 
              row.names = FALSE,  col.names = TRUE, qmethod = c("escape", "double"),  fileEncoding = "") 
    ...
    write.table(quartile100_matrix2 , 
              file = paste(path_temp_sub1,   "5A_quartile100_matrix.txt",  sep="/"), 
              append = FALSE, quote = FALSE, sep = "\t", eol = "\n", na = "NA", dec = ".", 
              row.names = FALSE,  col.names = TRUE, qmethod = c("escape", "double"),  fileEncoding = "")  
    MyBoxViolinPlot_1_f(vector2 = as.vector(quartile100_matrix2) ,   
                    sampleType2 = rep(x= mytech2_level ,  each=nrow(matrix_temp)  )   ,  
                    colours2    = MyTech_color_g(  mytech2_level  ),   
                    path2       = path_temp_sub1,   fileName2 = "5B_quartile100_matrix",  
                    title2="quartile100",  xLab2="Samples",  yLab2="quartile100 of methylation level (%)",    
                    height2=4,   width2= length(mytech2_level)/2+2,   Ymin2=0, Ymax2=100)
    write.table( cbind(as.vector(quartile100_matrix2), rep(x= mytech2_level ,  each=nrow(matrix_temp)  ) ) , 
              file = paste(path_temp_sub1,   "5C_quartile100_matrix.txt",  sep="/"), 
              append = FALSE, quote = FALSE, sep = "\t", eol = "\n", na = "NA", dec = ".", 
              row.names = FALSE,  col.names = TRUE, qmethod = c("escape", "double"),  fileEncoding = "") 
    ...
    MyBoxViolinPlot_1_f(vector2 = as.vector(variance_matrix2) ,   
                    sampleType2 = rep(x= mytech2_level ,  each=nrow(matrix_temp)  )   ,  
                    colours2    = MyTech_color_g(  mytech2_level  ),   
                    path2       = path_temp_sub1,   fileName2 = "9B_variance_matrix_0-50",  
                    title2="variance",  xLab2="Samples",  yLab2="variance of methylation level (%)",    
                    height2=4,   width2= length(mytech2_level)/2+2,   Ymin2=0, Ymax2=50)
    ...
    write.table(Harmonic_mean_matrix2 , 
              file = paste(path_temp_sub1,   "11A_Harmonic_mean_matrix.txt",  sep="/"), 
              append = FALSE, quote = FALSE, sep = "\t", eol = "\n", na = "NA", dec = ".", 
              row.names = FALSE,  col.names = TRUE, qmethod = c("escape", "double"),  fileEncoding = "")  
    MyBoxViolinPlot_1_f(vector2 = as.vector(Harmonic_mean_matrix2) ,   
                    sampleType2 = rep(x= mytech2_level ,  each=nrow(matrix_temp)  )   ,  
                    colours2    = MyTech_color_g(  mytech2_level  ),   
                    path2       = path_temp_sub1,   fileName2 = "11B_Harmonic_mean_matrix",  
                    title2="Harmonic_mean",  xLab2="Samples",  yLab2="Harmonic_mean of methylation level (%)",    
                    height2=4,   width2= length(mytech2_level)/2+2,   Ymin2=0, Ymax2=100)
    write.table( cbind(as.vector(Harmonic_mean_matrix2), rep(x= mytech2_level ,  each=nrow(matrix_temp)  ) ) , 
              file = paste(path_temp_sub1,   "11C_Harmonic_mean_matrix.txt",  sep="/"), 
              append = FALSE, quote = FALSE, sep = "\t", eol = "\n", na = "NA", dec = ".", 
              row.names = FALSE,  col.names = TRUE, qmethod = c("escape", "double"),  fileEncoding = "") 
    ...
    write.table(Geometric_mean_matrix2 , 
              file = paste(path_temp_sub1,   "12A_Geometric_mean_matrix.txt",  sep="/"), 
              append = FALSE, quote = FALSE, sep = "\t", eol = "\n", na = "NA", dec = ".", 
              row.names = FALSE,  col.names = TRUE, qmethod = c("escape", "double"),  fileEncoding = "")  
    MyBoxViolinPlot_1_f(vector2 = as.vector(Geometric_mean_matrix2) ,   
                    sampleType2 = rep(x= mytech2_level ,  each=nrow(matrix_temp)  )   ,  
                    colours2    = MyTech_color_g(  mytech2_level  ),   
                    path2       = path_temp_sub1,   fileName2 = "12B_Geometric_mean_matrix",  
                    title2="Geometric_mean",  xLab2="Samples",  yLab2="Geometric_mean of methylation level (%)",    
                    height2=4,   width2= length(mytech2_level)/2+2,   Ymin2=0, Ymax2=100)
    write.table( cbind(as.vector(Geometric_mean_matrix2), rep(x= mytech2_level ,  each=nrow(matrix_temp)  ) ) , 
              file = paste(path_temp_sub1,   "12C_Geometric_mean_matrix.txt",  sep="/"), 
              append = FALSE, quote = FALSE, sep = "\t", eol = "\n", na = "NA", dec = ".", 
              row.names = FALSE,  col.names = TRUE, qmethod = c("escape", "double"),  fileEncoding = "") 
    ...
    write.table(Quadratic_mean_matrix2 , 
              file = paste(path_temp_sub1,   "14A_Quadratic_mean_matrix.txt",  sep="/"), 
              append = FALSE, quote = FALSE, sep = "\t", eol = "\n", na = "NA", dec = ".", 
              row.names = FALSE,  col.names = TRUE, qmethod = c("escape", "double"),  fileEncoding = "")  
    MyBoxViolinPlot_1_f(vector2 = as.vector(Quadratic_mean_matrix2) ,   
                    sampleType2 = rep(x= mytech2_level ,  each=nrow(matrix_temp)  )   ,  
                    colours2    = MyTech_color_g(  mytech2_level  ),   
                    path2       = path_temp_sub1,   fileName2 = "14B_Quadratic_mean_matrix",  
                    title2="Quadratic_mean",  xLab2="Samples",  yLab2="Quadratic_mean of methylation level (%)",    
                    height2=4,   width2= length(mytech2_level)/2+2,   Ymin2=0, Ymax2=100)
    write.table( cbind(as.vector(Quadratic_mean_matrix2), rep(x= mytech2_level ,  each=nrow(matrix_temp)  ) ) , 
              file = paste(path_temp_sub1,   "14C_Quadratic_mean_matrix.txt",  sep="/"), 
              append = FALSE, quote = FALSE, sep = "\t", eol = "\n", na = "NA", dec = ".", 
              row.names = FALSE,  col.names = TRUE, qmethod = c("escape", "double"),  fileEncoding = "") 
    ...
    write.table(Trim_Arithmetic_mean_matrix2 , 
              file = paste(path_temp_sub1,   "15A_Trim_Arithmetic_mean_matrix.txt",  sep="/"), 
              append = FALSE, quote = FALSE, sep = "\t", eol = "\n", na = "NA", dec = ".", 
              row.names = FALSE,  col.names = TRUE, qmethod = c("escape", "double"),  fileEncoding = "")  
    MyBoxViolinPlot_1_f(vector2 = as.vector(Trim_Arithmetic_mean_matrix2) ,   
                    sampleType2 = rep(x= mytech2_level ,  each=nrow(matrix_temp)  )   ,  
                    colours2    = MyTech_color_g(  mytech2_level  ),   
                    path2       = path_temp_sub1,   fileName2 = "15B_Trim_Arithmetic_mean_matrix",  
                    title2="Trim_Arithmetic_mean",  xLab2="Samples",  yLab2="Trim_Arithmetic_mean of methylation level (%)",    
                    height2=4,   width2= length(mytech2_level)/2+2,   Ymin2=0, Ymax2=100)
    write.table( cbind(as.vector(Trim_Arithmetic_mean_matrix2), rep(x= mytech2_level ,  each=nrow(matrix_temp)  ) ) , 
              file = paste(path_temp_sub1,   "15C_Trim_Arithmetic_mean_matrix.txt",  sep="/"), 
              append = FALSE, quote = FALSE, sep = "\t", eol = "\n", na = "NA", dec = ".", 
              row.names = FALSE,  col.names = TRUE, qmethod = c("escape", "double"),  fileEncoding = "") 
    ...
    MyBoxViolinPlot_1_f(vector2 = as.vector(coefficientOfVariation_matrix2) ,   
                    ...
                    height2=4,   width2= length(mytech2_level)/2+2,   Ymin2=0, Ymax2=2 )
  ...
  write.table(matrix_temp2 , 
   ...
   sink( paste(path_temp_sub5, "dimensions_16stats.txt", sep="/") )
    ...
    MyBoxViolinPlot_1_f(vector2 = as.vector(variance_matrix2) ,   
                    sampleType2 = rep(x= mytech2_level ,  each=nrow(matrix_temp2)  )   ,  
                    colours2    = MyTech_color_g(  mytech2_level  ),   
                    path2       = path_temp_sub5,   fileName2 = "9B_variance_matrix_0-50",  
                    title2="variance",  xLab2="Samples",  yLab2="variance of methylation level (%)",    
                    height2=4,   width2= length(mytech2_level)/2+2,   Ymin2=0, Ymax2=50)    
  ...
  MyMultidimensionalScaling_1_g(  meLevelMatrix2=matrix_temp2,   path2=path_temp2_sub3,   dataFrame_temp2=dataFrame_temp2  )
  ...
  myHierarchicalClustering_1_g(  mat_3three=matrix_temp2,   path_temp1=path_temp2_sub5,  width1=length( as.vector(dataFrame_temp2$mysampleID) )/3 + 2, height1=5   )
