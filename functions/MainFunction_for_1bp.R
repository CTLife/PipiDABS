...
#)
myMainFunction1bp_1_g  <- function(  myobj_temp2,   path_temp2,  qvalue_temp2, differenceOfMethylation_temp2, mergeDistance_temp2,  dataFrame_temp2, numCores_temp2  ) {               
  ...
  tryCatch(
    myTempFunction101(),
    error = function(err){"myMainFunction_1bp_g_11133355555"}
  )
  ...
  tryCatch(
    myTempFunction102(),
    error = function(err){"myMainFunction_1bp_g_111222333"}
  )
