...
myCompare_10groups_tiles_g <- function(methylBase_temp_1,  myPath_temp_1,  qvalue_temp_1,  differenceOfMethylation_temp_1,   windowSize_temp_1,     stepSize_temp_1,    mergeDistance_temp_1,   minBases_temp_1,  numCores_temp_1 ) {                                             
