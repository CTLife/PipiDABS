...
myCompare_10groups_1bp_g <- function(methylBase_temp_1,  myPath_temp_1,  qvalue_temp_1,  differenceOfMethylation_temp_1,      mergeDistance_temp_1=100,   numCores_temp_1=8 ) {                                             
